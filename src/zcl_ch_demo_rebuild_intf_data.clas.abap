CLASS zcl_ch_demo_rebuild_intf_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_ch_demo_rebuild_intf_data IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    zcl_ch_demo_rebuild_intf_data=>rebuild_data( ).
  ENDMETHOD.
  METHOD rebuild_data.
    DATA:
    ...
    INSERT zch_dmo_cname FROM TABLE @lt_names.
    COMMIT WORK.
  ENDMETHOD.
